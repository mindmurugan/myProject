 ...
 *
 * Vector.hpp is free software: you can redistribute it and/or modify it
 * under the terms of the GNU General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * Vector.hpp is distributed in the hope that it will be useful, but
...
public:
    ...
    // printing
    void print(HardwareSerial & serial=Serial, const char * msg="", size_t format=0) const
    {
        serial.print(msg);
        for (size_t i=0;i<getSize();i++)
        {
    ...
    // self test
    static bool selfTest(HardwareSerial & serial=Serial)
    {
